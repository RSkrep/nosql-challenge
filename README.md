...
For this challenge we had to utilize MongoDB and NoSQL. this challenge was split into three parts. 

Part 1. Use NoSQL_setup_starter.ipynb for this section of the challenge.
...
Part 2.Use NoSQL_setup_starter.ipynb for this section of the challenge.
...
unfortunatly the recources file labled establishments could not be updated due to a file size error with github. However, the file will be created when running the script provided.
